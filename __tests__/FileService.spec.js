...
describe('createFolders', () => {
  it('creates upload folder', () => {
    ...
    //returns if the folder exist otherwise returns false
...
describe('Scheduled unused file clean up', () => {
  ...
  it('removes the 24 hours old file with attachment entry if not used in hoax', async () => {
    ...
    //creating a file that is not associated with any hoax
  ...
  it('keeps the files younger than 24 hours and their database entry even not associated with hoax', async () => {
    jest.useFakeTimers();
  ...
  it('keeps the files older than 24 hours and their database entry if it is associated with hoax', async () => {
    jest.useFakeTimers();
